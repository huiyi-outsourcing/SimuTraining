...
namespace SimuTraining.util
{
    ...
    {   
        ...
        public static void init() 
        {
            ...
            {
                // 视频页面信息
                info.Add("连、营抢救组的主要任务和救治原则.d", "及时、正确、有效地对伤员实施包扎、止血、固定、搬运、通气等急救措施，不仅能挽救伤员生命，减少阵亡和伤残率，而且为以后的救治机构实施救治创造了条件。同时，对鼓舞士气，提高部队战斗力有重要的意义。\n连抢救组是战（现）场急救的基本力量，其主要任务和救治原则有：\n（一）运用跟、看、问、听、找等方法迅速寻找、发现、搬运和隐蔽伤员；（二）依照先抢后救，先重后轻，先急后缓，先近后远的救护原则并灵活掌握，及时准确地对伤员实行急救；\n（三）战现场实施救治过程中遵循“六不”“五要”：\n  “六不”：不摸（不准用手或脏物接触伤口）；不冲（不用水冲洗伤口，但烧伤和化学武器致伤除外）；不取（不准轻易取出伤口异物）；不送（一般不准送回突出体腔的内脏）；不复（不对骨折断端进行复位）；不上药（不准给伤口涂抹药物）；\n  “五要”：要快（急救要迅速敏捷）；要准（包扎伤口要准确、严密、不漏包伤口）；要轻（以免增加伤员痛苦加重伤情）;要牢（包扎固定要牢靠，以防脱落或移动）；要细（处置伤口要仔细）。\n（四）积极组织迅速后送伤（病）员，做好伤（病）员后送前的各种准备，组织轻伤员尽快离开战（现）场；\n（五）领发急救药材，配发单兵卫生装备，并指导其正确使用。\n卫生员和卫生战士是连抢救组的中坚力量，战（现）场急救主要依托他们完成的。然而现代战争，由于作战理念发展、武器效能增强，前后方界限模糊，加之非战争军事任务日益加重，非常态状况发生的机率较高，这就对官兵自救互救提出了更高的要求，在战（现）场，要求官兵不能被动等待抢救组的救援，必须积极的自救互救，只有这样才能为后续的抢救和治疗赢得更多的时间。");
                ...
                // 描述页信息
                info.Add("连、营抢救组的主要任务和救治原则.dd", "这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页");
                ...
                info.Add("通气.d", "这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页这是文字说明页");
            ...
            {
                MessageBox.Show("描述添加出现重复项，请排查！" + e.Message);
            }
        }
    }
}
